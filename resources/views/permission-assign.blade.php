    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <form action="{{ url('admin/permission-assign') }}" id="roleForm">
                ...
                <form action="{{ url('admin/permission-assign') }}" method="post" id="permissionForm">
                    @csrf
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        @empty
                            <p class="p-5">No Permission Found</p>
                        @endforelse
                    </div>
